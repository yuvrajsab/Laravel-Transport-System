...
@section('content_header_title', 'New Driver')

@section('content')
    <div class="box box-primary">
        <form id="form" action="{{ route('driver.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="licence_number" name="licence_number" value="{{ old('licence_number') }}" placeholder="Enter licence number without spaces" required maxlength="13">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                            <label for="licence_rto">Licence RTO *</label>
                            <input type="text" class="form-control" id="licence_rto" name="licence_rto" value="{{ old('licence_rto') }}" placeholder="Enter licence rto" required maxlength="255">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="licence_validity" name="licence_validity" value="{{ old('licence_validity') }}" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask="" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-4">
