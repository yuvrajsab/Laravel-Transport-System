...
@section('title', 'Vehicle Owner Create')

@push('stylesheets')
    <link rel="stylesheet" href="{{ asset('bower_components/select2/dist/css/select2.min.css') }}">
@endpush

@section('content_header_title', 'New Vehicle Owner')

@section('content')
    <div class="box box-primary">
        <form id="form" action="{{ route('vehicle_owner.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
