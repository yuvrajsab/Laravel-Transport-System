...
@section('title', 'Consignee Create')

@push('stylesheets')
    <link rel="stylesheet" href="{{ asset('bower_components/select2/dist/css/select2.min.css') }}">
@endpush

@section('content_header_title', 'New Consignee')

@section('content')
    <div class="box box-primary">
        <form id="form" action="{{ route('consignee.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
